...
public class Rechner {
	Exception e;
	private DoubleDoubleZuDouble multiplikation = (zahl_1, zahl_2) -> {
		return zahl_1 * zahl_2;
	};
	private DoubleDoubleZuDouble nullstelle = (zahl_1, zahl_2) -> {
		return (0 - zahl_2) / zahl_1;
	};
	...
	public static void main(String[] args) {
		...
		System.out.println(rechner.berechne(Operation.DIVISION, 12, 0));
